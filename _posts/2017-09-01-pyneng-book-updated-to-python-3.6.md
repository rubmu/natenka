...
Теперь версия для Python 3.6 используется как основная.
И на неё можно перейти с главной [страницы книги на GitBook](https://www.gitbook.com/book/natenka/pyneng/details).
