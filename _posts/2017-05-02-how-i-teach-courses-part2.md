...
> Так Наташа и написала столько статьей на xgu.ru :)
...
Этот контекст помогает понять где используется технология, когда и позволяет им понять актуально ли она для них.
...
Если это были статьи linkmeup.ru, то никаких проблем, я их взахлеб рекламировала.
Как только надо было сказать про свою статью на xgu.ru, у меня сразу ступор.
...
Если шутка по теме, так вообще отлично.
