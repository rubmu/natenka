...
Лекции проводятся на выходных (суббота-воскресенье). Все лекции будут доступны в записи.

Кроме лекций, которые перечислены в таблице ниже, в курсе также есть несколько бонусных лекций, которые не проводятся онлайн, а доступны только в записи:
