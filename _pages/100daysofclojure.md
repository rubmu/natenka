...
Я начала учить Clojure из-за того, что хотела разобраться с каким-то функциональным яз
ыком программирования.

Выбрала я именно Clojure из-за того, что мне очень нравилось, что и как о нем говорят.
В основном, я сталкивалась с упоминаниями Clojure в подкасте [SE-Radio](http://www.se-radio.net/). При этом, это не были подкасты посвященные Clojure, он просто всплывал в
разговоре.

Но в то же время я действительно хочу разобраться с функциональным программированием,
понять его и перестроить мышление.
...
Сегодня продолжаю проходить курс по Haskell. Решила пару дней позаниматься им, чтобы п
обольше вовлечься.
